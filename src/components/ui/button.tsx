...
const buttonVariants = cva(
  'inline-flex items-center justify-center whitespace-nowrap text-sm rounded-md font-semibold uppercase transition-colors disabled:pointer-events-none disabled:opacity-50',
  {
    variants: {
      variant: {
        ...
        ghost: 'hover:bg-cream-100 hover:text-navy-600',
